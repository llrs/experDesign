...
# Information content of the categories should be more or less equal
# Distribution of the numeric values should be uniform
...
.evaluate_cat <- function(i, pheno, remove_e) {
  ...
  # Compare with the optimum 1: Non informative == random
