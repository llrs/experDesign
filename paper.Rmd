...
OSAT might return less rows than the input provided because they might have NA value.
...
```{r panel1, echo=FALSE, message=FALSE, warning=FALSE}
(osat_smoke/(osat_age + osat_sex) / anticlust & plot_layout(guides = 'collect')
```
