...
```{r osat, fig.cap="Sample distributions with OSAT."}
library("ggplot2")
...
```{r anticlust, error=TRUE, fig.cap="Sample distributions with anticlust."}
library("anticlust")
...
```{r experDesign, fig.cap="Sample distributions with experDesign."}
library("experDesign")
