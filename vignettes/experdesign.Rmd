...
Even with this measures you might end up with some batch effect due to:
 ...
 - Lack of [replicates](https://en.wikipedia.org/wiki/Replication_(statistics))
  If you can't provide new replicates, aim to provide more technical replicates
 - Processing
  If there is a change on the methodology, or you pause and resume later the sample collection there might be changes on the outcome. 
